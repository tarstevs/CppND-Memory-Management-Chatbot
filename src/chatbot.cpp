...
ChatBot::ChatBot(std::string filename) { // NOLINT
  std::cout << "ChatBot Constructor" << std::endl;

  // invalidate data handles
  _chatLogic = nullptr; // NOLINT
  _rootNode = nullptr; // NOLINT
...
// 4. Move assignment
ChatBot &ChatBot::operator=(ChatBot &&rhs) noexcept {
  if (this != &rhs) {
